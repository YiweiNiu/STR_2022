---
title: "chromDensity.gnomAD_npSTR"
---

```{r knitr, include = FALSE}
DOCNAME = "chromDensity.gnomAD_npSTR"
...
dat = read_delim(file.path(dat_dir, 'npSTR.bin_count'), delim = '\t', col_names = F)
...
```{r}
pdf(here::here("output", DOCNAME, "Fig.npSTR_density_metaIdiograms.perPeriod.pdf"),
...
```{r}
pdf(here::here("output", DOCNAME, "Fig.npSTR_density_meta.byChromContext.dotplots.pdf"),
    height = 2, width = 3.2)
...
```{r}
pdf(here::here("output", DOCNAME, "Fig.npSTR_density_idiograms.Period6.pdf"),
    height = 5, width = 7)
