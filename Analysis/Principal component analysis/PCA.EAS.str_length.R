...
# nohup Rscript analysis/PCA.EAS.str_length.R > analysis/PCA.EAS.str_length.log &
...
# load dat
mat_dir = '/niuyw-usb-disk/Projects/STR/PCA/EAS/random1'
...
# load dat
mat_dir = '/niuyw-usb-disk/Projects/STR/PCA/EAS/random2'
chroms = paste0("chr", 1:22)
mat_lst = lapply(chroms, function(x){
  fname = file.path(mat_dir, paste0(x, ".length.csv"))
  read_csv(fname)
...
# load dat
mat_dir = '/niuyw-usb-disk/Projects/STR/PCA/EAS/random3'
chroms = paste0("chr", 1:22)
mat_lst = lapply(chroms, function(x){
  fname = file.path(mat_dir, paste0(x, ".length.csv"))
  read_csv(fname)
